...
void c_handle_fastpath_simple_call(word_t tcbDest, word_t msgInfo)
    VISIBLE SECTION(".vectors.text");

void c_handle_fastpath_simple_recv(word_t tcbDest, word_t msgInfo)
    VISIBLE SECTION(".vectors.text");

void c_handle_fastpath_simple_send(word_t tcbDest, word_t msgInfo)
    VISIBLE SECTION(".vectors.text");

void  c_handle_get_cur_time(void)
    VISIBLE SECTION(".vectors.text");

void c_handle_fastpath_simple_reply_recv(word_t tcbDest, word_t msgInfo)
    VISIBLE SECTION(".vectors.text");
