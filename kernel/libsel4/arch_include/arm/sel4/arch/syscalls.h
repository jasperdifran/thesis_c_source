...
LIBSEL4_INLINE_FUNC seL4_MessageInfo_t simple_Call(seL4_Word destTCB, seL4_MessageInfo_t msgInfo)
{
    seL4_MessageInfo_t info;
    seL4_Word msg0 = seL4_GetMR(0);
    seL4_Word msg1 = seL4_GetMR(1);
    ...
    arm_sys_send_recv(seL4_SysSimpleCall, destTCB, &destTCB, msgInfo.words[0], &info.words[0], &msg0, &msg1, &msg2, &msg3, 0);
...
simple_Recv(seL4_Word destTcb, seL4_MessageInfo_t msgInfo)
{
    seL4_MessageInfo_t info;
    seL4_Word badge;
    seL4_Word msg0;
    ...
    arm_sys_send_recv(seL4_SysSimpleRecv, destTcb, &badge, msgInfo.words[0], &info.words[0], &msg0, &msg1, &msg2, &msg3, 0);
...
LIBSEL4_INLINE_FUNC seL4_MessageInfo_t
simple_Send(seL4_Word destTcb, seL4_MessageInfo_t msgInfo)
{
    seL4_MessageInfo_t info;
    seL4_Word badge;
    seL4_Word msg0;
    ...
    arm_sys_send_recv(seL4_SysSimpleSend, destTcb, &badge, msgInfo.words[0], &info.words[0], &msg0, &msg1, &msg2, &msg3, 0);
...
LIBSEL4_INLINE_FUNC seL4_MessageInfo_t
simple_ReplyRecv(seL4_Word destTcb, seL4_MessageInfo_t msgInfo)
{
    seL4_MessageInfo_t info;
    seL4_Word badge;
    seL4_Word msg0;
    ...
    arm_sys_send_recv(seL4_SysSimpleReplyRecv, destTcb, &badge, msgInfo.words[0], &info.words[0], &msg0, &msg1, &msg2, &msg3, 0);
...
LIBSEL4_INLINE_FUNC seL4_Word simple_GetTCBPointer(seL4_CPtr cap)
{
    seL4_Word unused0 = 0;
    seL4_Word unused1 = 0;
    seL4_Word unused2 = 0;
    ...
    arm_sys_send_recv(seL4_SysSimpleGetTCBPointer, cap, &result, 0, &unused0, &unused1, &unused2, &unused3, &unused4, 0);
    return result;
}

LIBSEL4_INLINE_FUNC seL4_Word simple_TCBReset(seL4_CPtr cap)
{
    seL4_Word unused0 = 0;
    seL4_Word unused1 = 0;
    seL4_Word unused2 = 0;
    ...
    arm_sys_send_recv(seL4_SysSimpleTCBReset, cap, &result, 0, &unused0, &unused1, &unused2, &unused3, &unused4, 0);
    return result;
}

LIBSEL4_INLINE_FUNC seL4_Word simple_GetCurrTime()
{
    seL4_Word time = 0;
    seL4_Word unused1 = 0;
    seL4_Word unused2 = 0;
    ...
    arm_sys_send_recv(seL4_SysGetCurTime, result, &result, 0, &unused1, &time, &unused2, &unused3, &unused4, 0);
    return time;
}
...
LIBSEL4_INLINE_FUNC void seL4_BenchmarkInvalidateTlb(void)
{
    arm_sys_send_null(seL4_SysBenchmarkInvalidateTlb, 0, 0);
    asm volatile("" ::
                     : "memory");
}
